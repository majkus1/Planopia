    ...
    <div className="alllogin">
      <div className="login-box">
        ...
        <div className="card">
          ...
          />
          <label htmlFor="rememberMe" style={{ marginLeft: "5px", fontWeight: "normal", cursor: "pointer", color: "black" }}>Zapamiętaj mnie</label>
        </div>
              ...
              <Link to="/reset-password" className="text-center" style={{ textDecoration: "none", color: "black" }}>Nie pamiętam hasła</Link>
            </form>
      ...
      <Link to="/aplikacja-dla-firm" className="linkaboutapp">O Aplikacji</Link>
    </div>
  );
}
